...
public class ObradaZahtjeva extends Thread {
    ...
    @Override
    public void run() {
        pozadinskaDretva = SlusacAplikacije.getPozadinskaDretva(); //treba mi pozadinska dretva kako bi mogao provjeriti njen rad
        while (radi) {
            this.pokreni();
        }
                        ...
                        case 1:
                            ...
                            if (rx.group(3).trim().isEmpty()) {//ako su uneseni samo podaci za prijavu
                                ...
                                if (ax == null) {
                                    ...
                                    if (pozadinskaDretva.isDretvaPreuzima()) {
                                        dbOp.dnevnik(user, naredba, "ERR 31");
                                        out.write("ERR 31.");
                                    } else {
                                    ...
                                    if (!pozadinskaDretva.isDretvaRadi()) {
                                        dbOp.dnevnik(user, naredba, "ERR 32");
                                        out.write("ERR 32.");
                                    } else {
                                    ...
                                    if (pozadinskaDretva.isDretvaRadi() && pozadinskaDretva.isDretvaPreuzima()) {
                                        dbOp.dnevnik(user, naredba, "OK 01");
                                        out.write("OK 01.");
                                    } else if (pozadinskaDretva.isDretvaRadi() && !pozadinskaDretva.isDretvaPreuzima()) {
                                        dbOp.dnevnik(user, naredba, "OK 00");
                                        out.write("OK 00.");
                                    } else {
                                        dbOp.dnevnik(user, naredba, "OK 02");
                                        out.write("OK 02.");
                                    }
                                    ...
                                    if (dbOp.dodajKorisnika(newUser, newPass, newRole)) {
                                        ...
                                        dbOp.dnevnik(user, naredba, "ERR 33");
                                        out.write("ERR 33.");
                                    }
