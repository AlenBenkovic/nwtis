 ...
 */
package org.foi.nwtis.dkermek.web.filteri;
...
import org.foi.nwtis.dkermek.web.NeuspjesnaPrijava;
import org.foi.nwtis.dkermek.web.kontrole.Korisnik;
...
public class KontrolaPristupa implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (request instanceof HttpServletRequest) {
            ...
            Object o = session.getAttribute("korisnik");
            if(! (o instanceof Korisnik)) {
                throw new NeuspjesnaPrijava("Korisnik nije prijavljen");
            }
        }
